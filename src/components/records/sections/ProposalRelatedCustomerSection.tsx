// ──────────────────────────────────────────────────────────────────────
// ProposalRelatedCustomerSection — shows the customer this proposal
// belongs to.
//
// Read-only summary card with click-through to open the customer as a
// record tab. Canonical customer-reassignment lives in the Overview
// section. Mirrors JobRelatedCustomerSection.
// ──────────────────────────────────────────────────────────────────────
...
interface ProposalRelatedCustomerSectionProps {
  record: Proposal
}

export default function ProposalRelatedCustomerSection({
  record,
}: ProposalRelatedCustomerSectionProps) {
    ...
    return (
      <div className="p-6 max-w-2xl">
        ...
        <p className="font-body text-sm text-text-secondary mt-2">
          The customer associated with this proposal is missing or
          unavailable. Reassign in the Overview tab.
        </p>
      </div>
    )
  }
